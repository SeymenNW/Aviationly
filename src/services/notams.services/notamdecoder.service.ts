...
(function (global) {
    ...
    function getCoords(coordinates) {
        if (coordinates.length === 14) {   // ex: 4025N00404W999
            ...
            const radius = +coordinates.substring(11, 14);
        ...
        if (coordinates.length === 15) { // ex: 402500N 075000W (15)
            ...
            return { lat, lng }; // Return lat, lng without radius
        }
    ...
    notamDecoder.decode = function (message) {
        ...
        if (typeof (message) === 'string' && message.trim() !== '') {
            ...
            if (n != null) {
                ...
                errors.push('Unable to convert input message');
            }
        } else {
            errors.push('Invalid input message');
        }
    ...
    // Expose the notamDecoder object to the ClearScript engine
    if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
        module.exports = notamDecoder;
    } else {
        global.notamDecoder = notamDecoder;
    }
})(this);